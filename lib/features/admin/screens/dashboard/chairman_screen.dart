...
class ChairmanDashboard extends StatefulWidget {
  ...
  @override
  State<ChairmanDashboard> createState() => _ChairmanDashbiardState();
}

class _ChairmanDashbiardState extends State<ChairmanDashboard> {
...
void main() {
  runApp(MaterialApp(home: ChairmanDashboard()));
}
