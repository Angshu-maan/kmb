...
class SessionManager {
  ...
  static bool get isLoggedIn =>
      ...
      sessionNotifier.value!.jwt.isNotEmpty;

  static bool get isAdmin =>
      sessionNotifier.value?.activeRole == 'administrator';

  static bool get isChairman =>
      sessionNotifier.value?.activeRole == 'chairman';

  static bool get isDealer =>
      sessionNotifier.value?.activeRole == 'dealings';

  static bool get isExecutive =>
      sessionNotifier.value?.activeRole == 'executive_officer';
